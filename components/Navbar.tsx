            ...
            <div className="max-w-[1280px] mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center">
                    <a
                        ...
                        className="flex items-center gap-2 rounded-full bg-brand-burgundy px-4 py-2 border border-white/30 text-white font-semibold hover:bg-brand-burgundy/90 transition-colors"
                    >
